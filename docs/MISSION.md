...
This repository is a **framework bridge**: it connects **[replayt](https://pypi.org/project/replayt/)** workflows to
...
- **Consumer-side (this repo):** Declaring and updating **version pins**, **compatibility shims**, LangGraph API drift,
  CI/test matrices, and release notes for the bridge. We do not expect replayt core to absorb LangGraph-specific details.
