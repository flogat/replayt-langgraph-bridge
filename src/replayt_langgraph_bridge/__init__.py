...
- ``BridgeInvokeContextError``: Missing or invalid LangGraph ``invoke`` ``context`` / replayt ``Runner`` before a step
  runs (see ``docs/GRAPH_CONSTRUCTION_ERRORS.md`` §3.4); exposes ``code`` (``missing_runner`` or
